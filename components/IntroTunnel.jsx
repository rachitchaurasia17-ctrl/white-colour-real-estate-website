/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    White Colour Real Estate lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for White Colour Real Estate (blue room, brand phrase).
*/
...
const PHRASE = 'White Colour Real Estate · '; // tiled on all 4 walls
